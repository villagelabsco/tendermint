...
func TestConsensusConfig_ValidateBasic(t *testing.T) {
	testcases := map[string]struct {
		...
		"PostTargetBufferDuration":             {func(c *ConsensusConfig) { c.PostTargetBufferDuration = time.Second }, false},
		"PostTargetBufferDuration negative":    {func(c *ConsensusConfig) { c.PostTargetBufferDuration = -1 }, true},
