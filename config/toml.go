...
# TargetHeightDuration is used to determine how long we wait after a
...
# PostTargetBufferDuration is an additional buffer added on top of target_height_duration
# in order to compensate for slower nodes
post_target_buffer_duration = "{{ .Consensus.PostTargetBufferDuration }}"
